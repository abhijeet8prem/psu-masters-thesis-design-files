...
#set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { }]; #IO_L17P_T2_34 Sch=ja_p[1]       #pin1 
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { M4_PWM_B }]; #IO_L17N_T2_34 Sch=ja_n[1]        #pin2 
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { M4_PWM_T}]; #IO_L7P_T1_34 Sch=ja_p[2]          #pin3 
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { M3_PWM_A}]; #IO_L7N_T1_34 Sch=ja_n[2]          #pin4 
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]  #pin7 
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { M4_PWM_A }]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]   #pin8 
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { M3_PWM_B }]; #IO_L22P_T3_34 Sch=ja_p[4]        #pin9 
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { M3_PWM_T }]; #IO_L22N_T3_34 Sch=ja_n[4]        #pin10

##PmodB

## Normal configure: SABC
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L8P_T1_34 Sch=jb_p[1]     #pin1
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { M2_PWM_T  }]; #IO_L8N_T1_34 Sch=jb_n[1]    #pin2
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { M2_PWM_B  }]; #IO_L1P_T0_34 Sch=jb_p[2]    #pin3
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { M1_PWM_A }]; #IO_L1N_T0_34 Sch=jb_n[2]     #pin4
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L18P_T2_34 Sch=jb_p[3]   #pin7
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { M2_PWM_A }]; #IO_L18N_T2_34 Sch=jb_n[3]    #pin8
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { M1_PWM_T }]; #IO_L4P_T0_34 Sch=jb_p[4]     #pin9
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { M1_PWM_B }]; #IO_L4N_T0_34 Sch=jb_n[4]     #pin10
